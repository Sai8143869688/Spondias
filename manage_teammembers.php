                                ...
                                <div class="page-heading-section mb-4">
                                    <div class="page-title-wrap">
                                        ...
                                        <div>
                                           ...
                                           <p class="subtitle">Manage team members and their profile details</p>
                                        </div>
                                    </div>
                                    <a href="add_team_member.php" class="btn-add-new">
    ...
    <script>
        $('#projects-table').DataTable({
            ...
            "oLanguage": {
               ...
               "sSearchPlaceholder": "Search team members...",
                "sLengthMenu": "Results :  _MENU_"
            },
            "stripeClasses": [],
            "lengthMenu": [7, 10, 20, 50],
            "pageLength": 10,
            "order": [[1, "asc"]], // default sort by Display Order
            "columnDefs": [
               { "orderable": false, "targets": [6, 8] }// project cell & actions not sortable
            ]
        });
