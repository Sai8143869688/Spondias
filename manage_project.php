                            ...
                            <div class="widget-content widget-content-area br-8">
                                ...
                                <div class="page-heading-section mb-4">
                                    <div class="page-title-wrap">
                                        ...
                                        <div>
                                            <h2>Projects</h2>
                                            <p class="subtitle">Manage all your portfolio projects in one place</p>
                                        </div>
                                    </div>
                                    <a href="add_project.php" class="btn-add-new">
                                    ...
                                    <table id="projects-table" class="table dt-table-hover" style="width:100%">
                                        ...
                                        $projects = [
                                            ...
                                            [
                                                ...
                                                "description" => "Real-time infrastructure monitoring for enterprise teams.",
                                                "category"    => "cloud",
                                                "image"       => "",
                                               
                                                "button_link" => "https://example.com/cloudsync",
                                            ...
                                            [
                                                ...
                                                "description" => "Cross-platform e-commerce app with AR product preview.",
                                                "category"    => "mobile_app",
                                                "image"       => "",
                                                
                                                "button_link" => "https://example.com/shopflow",
                                            ...
                                            [
                                                "title"       => "DevPortal Pro",
                                                "description" => "API documentation & developer portal builder.",
                                                "category"    => "web_app",
                                                "image"       => "",
                                              
                                                "button_link" => "https://example.com/devportal",
                                            ...
                                            [
                                                "title"       => "NeuralVision",
                                                "description" => "Computer vision pipeline for defect detection in manufacturing.",
                                                "category"    => "ai_ml",
                                                "image"       => "",
                                        ...
                                        $category_map = [
                                            'web_app'    => ['cls' => 'web-app',    'label' => 'Web App'],
                                            'mobile_app' => ['cls' => 'mobile-app', 'label' => 'Mobile App'],
                                            'cloud'      => ['cls' => 'cloud',      'label' => 'Cloud'],
                                            'ai_ml'      => ['cls' => 'ai-ml',      'label' => 'AI / ML'],
                                        ];

                                        foreach ($projects as $i => $row):
                                            $sno = $i + 1;
                                            $cat = $category_map[$row['category']] ?? ['cls' => '', 'label' => $row['category']];
                                        ?>
                                        <tr>
                                            <!-- SNO -->
                                            ...
                                            <!-- ORDER -->
                                            <td>
                                                <span class="order-badge"><?= (int)$row['order'] ?></span>
                                            </td>
                                            ...
                                            <td>
                                                <div class="action-btns justify-content-center">
                                                    <button class="action-btn view" title="View" onclick="viewProject(<?= $sno ?>)">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                                                    </button>
                                                    <button class="action-btn edit" title="Edit" onclick="editProject(<?= $sno ?>)">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
                                                    </button>
                                                    <button class="action-btn delete" title="Delete" onclick="deleteProject(<?= $sno ?>)">
    ...
    <script>
        $('#projects-table').DataTable({
            ...
            "oLanguage": {
                ...
                "sSearchPlaceholder": "Search projects...",
