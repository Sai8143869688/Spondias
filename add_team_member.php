...
<body class="layout-boxed">
            ...
            <div class="layout-px-spacing">
                <div class="middle-content p-0">
                    ...
                    <div class="secondary-nav">
                        <div class="breadcrumbs-container" data-page-heading="Add profile">
                                    ...
                                    <div class="page-header">
                                        ...
                                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                               ...
                                               <li class="breadcrumb-item"><a href="manage_team_members.php">Team Members</a></li>
                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                            ...
                            <div class="page-heading-section">
                                <div class="page-title-wrap">
                                    ...
                                    <div>
                                        ...
                                        <p class="subtitle">Fill in the details below to add a new team member</p>
                                    </div>
                                </div>
                                <a href="manage_team_members.php" class="btn-back">
                            ...
                            <div class="form-card">
                                ...
                                <div class="form-card-body">
                                    <form id="profileForm" method="POST" action="save_profile.php" enctype="multipart/form-data" novalidate>
                                        <?php
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group-custom">
                                                    <label class="form-label-custom">
                                                        Technology Stack <span class="required">*</span>
                                                    </label>
                                                    <input type="text"
                                                           class="form-control-custom"
                                                           id="technology_stack"
                                        ...
                                        <div class="form-group-custom">
                                            <label class="form-label-custom">
                                                Profile Image <span class="required">*</span>
                                            </label>
                                            <div class="upload-zone" id="uploadZone">
                                                <input type="file" id="member_image" name="member_image" accept="image/*" required onchange="previewImage(this)">
                                                ...
                                                <p class="upload-sub">or <span>browse to upload</span> &nbsp;·&nbsp; PNG, JPG, WebP up to 5 MB</p>
                                            </div>
                                            <div id="imagePreviewWrap">
                                                <img id="imagePreview" src="" alt="Profile preview">
                                                <button type="button" class="preview-remove-btn" onclick="removeImage()" title="Remove image">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
                                                </button>
                                            </div>
                                            <div class="field-error" id="member_image-error">Please upload a profile image.</div>
                                        </div>   
                                        </div>
                                        ...
                                        <div class="row align-items-start">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group-custom">
                                                    ...
                                                    <div class="order-stepper">
                                                        <button type="button" onclick="changeOrder(-1)" aria-label="Decrease order">
                                                        ...
                                                        <input type="number" id="display_order" name="display_order" value="1" min="1" max="999" required readonly>
                                                        <button type="button" onclick="changeOrder(1)" aria-label="Increase order">
                                                    ...
                                                    <div class="field-hint">Position in the profile listing</div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group-custom">
                                                    ...
                                                    <div class="field-hint">Active profiles are publicly visible</div>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        function updateCategoryBadge() {
            const sel   = document.getElementById('profile_category');
        ...
        zone.addEventListener('drop', e => {
            ...
            if (file && file.type.startsWith('image/')) {
                ...
                dt.items.add(file);
                document.getElementById('member_image').files = dt.files;
                previewImage(document.getElementById('member_image'));
            }
        });
        ...
        document.getElementById('profileForm').addEventListener('submit', function(e) {
            ...
            // Text / select fields
            const textFields = [
                { id: 'profile_title',       check: v => v.trim() !== '' },
                { id: 'profile_category',    check: v => v !== '' },
                { id: 'profile_description', check: v => v.trim() !== '' },
            ];
            ...
            // Image
            const imgInput = document.getElementById('member_image');
            const imgErr   = document.getElementById('member_image-error');
        ...
        // Live clear on blur
        ['profile_title','profile_category','profile_description','button_link'].forEach(function(id) {
            const el = document.getElementById(id);
            if (!el) return;
