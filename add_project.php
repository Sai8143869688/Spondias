                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                            ...
                            <div class="page-heading-section">
                                <div class="page-title-wrap">
                                    ...
                                    <div>
                                        ...
                                        <p class="subtitle">Fill in the details below to publish a new project</p>
                                    </div>
                                </div>
                            ...
                            <div class="form-card">
                                ...
                                <div class="form-card-body">
                                    <form id="projectForm" method="POST" action="save_project.php" enctype="multipart/form-data" novalidate>
                                        <?php
                                                ...
                                                <div class="form-group-custom">
                                                    ...
                                                    <div class="select-wrap input-icon-wrap">
                                                        ...
                                                        >
                                                            ...
                                                            <option value="web_app"    data-badge="web-app">Web App</option>
                                                            <option value="mobile_app" data-badge="mobile-app">Mobile App</option>
                                                            <option value="cloud"      data-badge="cloud">Cloud</option>
                                                            <option value="ai_ml"      data-badge="ai-ml">AI / ML</option>
                                                        </select>
                                                    </div>
                                                    <div id="categoryBadgeWrap" style="display:none;">
                                        ...
                                        <div class="form-group-custom">
                                            ...
                                            <div class="d-flex justify-content-between align-items-start mt-1">
                                                ...
                                                <span class="char-counter"><span id="descCount">0</span>/500</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group-custom">
                                            ...
                                            <div class="upload-zone" id="uploadZone">
                                                <input type="file" id="project_image" name="project_image" accept="image/*" required onchange="previewImage(this)">
                                            ...
                                            <div id="imagePreviewWrap">
                                                <img id="imagePreview" src="" alt="Project preview">
                                            ...
                                            <div class="field-error" id="project_image-error">Please upload a project image.</div>
                                        </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group-custom">
                                                    ...
                                                    <div class="radio-toggle-group">
                                                        <input type="radio" id="featured_yes" name="featured" value="yes" required>
                                                        <label for="featured_yes">
                                                            <span class="dot"></span> Yes
                                                        </label>
                                                        <input type="radio" id="featured_no" name="featured" value="no" checked>
