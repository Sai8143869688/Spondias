            ...
            <div class="layout-px-spacing">
                <div class="middle-content p-0">
                    ...
                    <div class="secondary-nav">
                       <div class="breadcrumbs-container" data-page-heading="Edit Project Category">
                                    ...
                                    <div class="page-header">
                                        ...
                                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item"><a href="project_categories.php">Project Categories</a></li>
                            ...
                            <div class="form-card">
                                ...
                                <div class="form-card-header">
                                    ...
                                    <span class="edit-pill">
                                        ...
                                        Editing Category ID #<?= $project['id'] ?>
                                    </span>
                                </div>
                                    ...
                                    <form id="editProjectForm" method="POST" action="update_project.php" enctype="multipart/form-data" novalidate>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group-custom">
                                                ...
                                                <select class="form-control-custom" name="category_name" required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group-custom">
                                                    <label class="form-label-custom" for="button_link">Link</label>
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <div class="form-actions-right">
                                                <a href="Projects_Categories_Management.php" class="btn-cancel">
